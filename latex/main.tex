...
\begin{table}
  ...
  \begin{tabular}{lccc}
    \toprule
    \multicolumn{4}{c}{Comparativa entre modelos} \\
    \cmidrule(r){1-4}
    Nombre     & MAE     & MSE    & R² Score \\
    \midrule
    Linear Regression & 0.24 & 0.147 & 0.843 \\
    Ensemble of RL    & 0.24 & 0.147 & 0.842 \\
    Stack    & 0.84 & 2.0 & 0.863 \\
    Bagging    & 0.81 & 1.79 & 0.878 \\
    Random Forest     & 0.82 & 1.71 & 0.883 \\
    SVR               & 2.10 & 6.87 & 0.86 \\
    \bottomrule
  \end{tabular}
\end{table}
